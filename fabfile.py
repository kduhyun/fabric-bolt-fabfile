...
def build():
    ...
    sudo("wget https://raw.githubusercontent.com/kduhyun/fabric-bolt-fabfile/master/master/setup.haproxy.sh -O /svc/shell/setup.haproxy.sh")
    sudo("sh /svc/shell/setup.haproy.sh")
